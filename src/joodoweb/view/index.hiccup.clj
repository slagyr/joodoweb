...
[:h3 "installation"]
[:a {:href "/install"} [:small "Click here for install instructions of latest version"]]
...
[:pre {:class "brush: clojure"} "lein plugin install joodo/lein-joodo 0.6.0-SNAPSHOT"]
[:p "The 'joodo' command will be installed on your system in the '~/.lein/bin/' directory. Next, edit the '.profile' (found in your home directory) to include '$HOME/.lein/bin/' in your path."]
