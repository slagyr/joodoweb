...
[:code [:pre "Exception in thread \"main\" java.lang.NoClassDefFoundError: joodo/kake/JoodoServer
...
[:p "To remedy this, simply run " [:code "lein deps"] " and then start your server again."]